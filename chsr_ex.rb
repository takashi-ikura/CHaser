...
#  Copyright (c) 2024 Takashi Ikura
#
...
#
#################################
# mod 2024-07-27 Takashi Ikura 
#--------------------------------
#  1.試合中の動きの表示とスリープをコメントにして、結果だけを表示するように変更
#  2.引数無しの時のマップのファイル名を「map_simple.map」へ変更
#  3.接続待機中の前にマップを表示するように変更
#################################
#
# 使い方：
#  コマンドラインで以下のコマンドを実行
#  マップは map_simple.map を初期値としています
#
#  ruby chsr_ex.rb
#
...
@name = []   # 名前
th =[]      # スレッド 管理用
mapfilename='map_simple.map'   # マップファイル名
@map = []                 # マップ
@bg_map = []              # 背景色マップ
@turn_max = 200           # 最大ターン数
@chara_x = []             # キャラ位置
